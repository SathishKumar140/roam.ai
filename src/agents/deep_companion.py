...
def create_roamai_companion(*, tools, model=None, system_prompt=None, request_context=None):
    ...
    routing = [
        (
            "travel_specialist",
            "travel-skills",
            "Flights, hotels, weather, local activities, routes and itineraries.",
            {
                "search_web",
                "search_events",
                "search_flights",
        ...
        (
            "vision_specialist",
            "vision-skills",
            "Inspect this request's attached venue, menu or receipt image; report uncertainty.",
            {"analyze_attached_image", "search_web"},
        ),
        (
            "expense_specialist",
            "expense-skills",
            "Propose evidence-backed expense splits, read balances and convert currencies. Never confirm on a person's behalf.",
            {"propose_group_expense", "get_group_balances", "convert_currency"},
        ),
        (
            "proactive_concierge",
            "concierge-skills",
            "Create agreed polls and schedule or cancel explicit reminders. No autonomous departure state transitions.",
            {"create_group_poll", "schedule_group_reminder", "cancel_group_reminder"},
        ),
        (
            "skill_specialist",
            "meta-skills",
            "Explain available capabilities and limitations. Installing or connecting servers is administrator-only.",
            set(),
        ),
