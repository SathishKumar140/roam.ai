...
from src.skills.mcp_skill_learner import connect_external_mcp_server, list_connected_mcp_skills, disconnect_mcp_server
...
def test_dynamic_mcp_skill_learning():
    ...
    connect_res = connect_external_mcp_server.invoke(
        {"server_name": "extra_travel_hub", "command": "python3", "args_json": '["-m", "src.mcp.servers.travel_mcp_server"]'}
    )
                    ...
                    tool_calls=[
                        {
                            ...
                            "id": "delegate",
                            "args": {
                                "subagent_type": "skill_specialist",
                                "description": "List the tools actually available to this request.",
                            },
                        }
                    ],
                ),
